...
public class ClientController {
	...
	private String request, username;
	...
	//this method sorts the card by ascending order
	public void sortCards() {
		if (this.isAscending()==true) {
			Collections.sort(cards, Card.CardValueAscComparator);
			Collections.sort(cards, Card.CardTypeAscComparator );
//			gui.updateAllPanels();
		}
		else {
			Collections.sort(cards, Card.CardValueDescComparator);
			Collections.sort(cards, Card.CardTypeAscComparator );
//			gui.updateAllPanels();
		}
	}
	public void setCardSortingAscening() {
		setAscending(true);
	}
	public void setCardSortingDescending() {
		setAscending(false);
	}
	...
	public boolean setAscending(boolean ascending) {
