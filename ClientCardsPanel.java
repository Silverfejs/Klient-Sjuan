 ...
 *
 */
public class ClientCardsPanel extends JLabel implements MouseListener{
	 ...
	 */
	public ClientCardsPanel (ClientGUI gui) {
		this.gui = gui;
...
//	public void sortCards(ArrayList<Card> playerCards) {
//		Collections.sort(playerCards);
//		setPlayersCardsInGUI(playerCards);
//
//	}
